...
\end{itemize}
Per esempio
\lstinputlisting[language=C++]{code/170.cpp}\label{code: 170}
Importante è che la lista sia omogenea:
\lstinputlisting[language=C++]{code/171.cpp}\label{code: 171}
In più il tipo delle liste non può essere dedotto durante il passaggio, quindi non può essere usato con i template:
\lstinputlisting[language=C++]{code/172.cpp}\label{code: 172}
...
\lstinputlisting[language=C++]{code/173.cpp}\label{code: 173}
E poi vediamo il suo corrispettivo in forma di funzione di un oggetto:
\lstinputlisting[language=C++]{code/174.cpp}\label{code: 174}
...
\lstinputlisting[language=C++]{code/175.cpp}\label{code: 175}
...
\lstinputlisting[language=C++]{code/176.cpp}\label{code: 176}

Se volessimo accedere a dei nomi locali dovremmo specificarlo o otterremmo un errore:
\lstinputlisting[language=C++]{code/177.cpp}\label{code: 177}
...
\end{itemize}
Ad esempio:
\lstinputlisting[language=C++]{code/178.cpp}\label{code: 178}
...
\subsubsection{Lambda e \textit{this}}
Includere this permette di includere all'interno di una lambda anche i membri della classe. Ad esempio:
\lstinputlisting[language=c++]{code/179}\label{code: 179}
Grazie al this i membri vengono acceduti direttamente e non vengono copiati nella lambda.

\subsubsection{\emph{mutable} lambda}
